...
<body class="bg-slate-50 text-slate-900">
    ...
    <nav class="glass sticky top-8 z-40 mx-4 mt-4 px-6 py-4 rounded-2xl border border-white/20 shadow-lg flex justify-between items-center">
        ...
        <div class="hidden md:flex gap-8 font-medium">
            ...
            <a href="{{ route('events.index') }}" class="hover:text-indigo-600 transition">Jelajahi Event</a>
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 pb-12 border-b border-indigo-400/20">
                ...
                <div class="md:col-span-3 text-left">
                    ...
                    <ul class="space-y-2.5 text-sm font-medium text-indigo-100/80">
                        <li><a href="{{ url('/?category=seminar-it') }}" class="hover:text-white transition-colors">Seminar IT</a></li>
                        <li><a href="{{ url('/?category=entertainment') }}" class="hover:text-white transition-colors">Entertainment</a></li>
                    </ul>
                </div>
                ...
                <div class="md:col-span-2 text-left">
                    ...
                    <ul class="space-y-2.5 text-sm font-medium text-indigo-100/80 break-words">
                        <li><a href="mailto:support@eventtiket.com" class="hover:text-white transition-colors block">support@eventtiket.com</a></li>
