...
<section id="events" class="max-w-7xl mx-auto px-6 py-20">
    ...
    <div class="flex justify-between items-end mb-12">
        ...
        <div class="flex flex-wrap items-center gap-3 bg-white p-4 rounded-2xl shadow-sm border border-slate-100">

            <a href="/"
                class="px-5 py-2.5 rounded-xl font-semibold transition duration-200
            ...
            @foreach($categories as $cat)
                ...
                <a href="/?category={{ $cat->slug }}"
                    class="px-5 py-2.5 rounded-xl font-semibold transition duration-200
                    bg-indigo-50 text-indigo-700 hover:bg-indigo-600 hover:text-white hover:shadow-lg">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        @empty
            ...
            <div class="col-span-3 text-center py-20">
                ...
                <h3 class="text-2xl font-bold text-slate-500 mb-2">
                    Belum ada event tersedia
                </h3>

                <p class="text-slate-400">
                    Silakan tambahkan data event terlebih dahulu.
                </p>
